# 96. Forecasting models

**Track:** ML  
**Companion notebook:** [../Practice/96-forecasting-models.ipynb](../Practice/96-forecasting-models.ipynb)

## Purpose

exponential smoothing, ARIMA, backtesting, intervals, and reconciliation.
...
**Forecasting models** belongs to **Machine learning** and is prioritized as **P2**. Its practical scope is exponential smoothing, ARIMA, backtesting, intervals, and reconciliation. The lesson treats those phrases as mechanisms to understand and verify, not vocabulary to memorize.

1. **Exponential Smoothing:** Define it, locate it in the system flow, and identify one measurable behavior.
2. **ARIMA:** Define it, locate it in the system flow, and identify one measurable behavior.
3. **Backtesting:** Define it, locate it in the system flow, and identify one measurable behavior.
4. **Intervals:** Define it, locate it in the system flow, and identify one measurable behavior.
5. **Reconciliation:** Define it, locate it in the system flow, and identify one measurable behavior.

**Study sequence:** Begin by drawing the input-to-output flow for Forecasting models. Next isolate each concept in a tiny example. Compare a baseline with one alternative, deliberately create a failure, and explain the observed evidence. Finally place the mechanism inside a realistic system with versioning, tests, monitoring, security, and a fallback.

**Mastery standard:** A learner has mastered Forecasting models when they can explain every listed concept without library jargon, implement or simulate the central mechanism, select an appropriate evaluation method, diagnose a counterexample, compare alternatives, and defend a production decision using explicit constraints.
...
A core part of Forecasting models; study its mechanism, inputs, outputs, parameters, evidence, and failure modes. Check accepted input shapes and types, return values, defaults, and fitted attributes before using it in a larger workflow.
...
1. **`exponential smoothing`**: A core part of Forecasting models; study its mechanism, inputs, outputs, parameters, evidence, and failure modes.
2. **`ARIMA`**: A core part of Forecasting models; study its mechanism, inputs, outputs, parameters, evidence, and failure modes.
3. **`backtesting`**: A core part of Forecasting models; study its mechanism, inputs, outputs, parameters, evidence, and failure modes.
4. **`intervals`**: A core part of Forecasting models; study its mechanism, inputs, outputs, parameters, evidence, and failure modes.
5. **`reconciliation`**: A core part of Forecasting models; study its mechanism, inputs, outputs, parameters, evidence, and failure modes.
...
1. Draw the complete state-transition diagram for **Forecasting models**.
